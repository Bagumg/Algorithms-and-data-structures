...
# Сильно длинное решение и не красивое получилось, решил разнести по функциям.
# Да и собственные отдельные функции конвертации десятиричных чисел в шеснадцатиричные и обратно, не помешают.
